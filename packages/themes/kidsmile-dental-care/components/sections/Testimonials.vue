      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
        ...
        <div class="lg:col-span-6 bg-gradient-to-br from-purple-100/90 via-white to-purple-50 p-6 sm:p-8 rounded-[2.5rem] border-2 border-purple-200/80 shadow-lg flex flex-col sm:flex-row gap-6 items-center justify-between">
          <div class="space-y-4 flex-1 text-start">
            ...
            <p class="text-sm sm:text-base font-semibold text-indigo-950 leading-relaxed italic">
            ...
            <div>
              <div class="text-sm font-extrabold text-indigo-950">{{ $t('testimonials.author1') }}</div>
              <div class="text-xs font-bold text-purple-700">{{ $t('testimonials.role1') }}</div>
            </div>
          </div>
          ...
          <div class="space-y-4 flex-1 text-start">
            ...
            <ul class="space-y-2 text-xs font-bold text-slate-700">
              <li class="flex items-center gap-2">
                ...
                <span>{{ $t('tour.feature1') }}</span>
              </li>
              <li class="flex items-center gap-2">
                <CheckCircle2 class="w-4 h-4 text-emerald-500 shrink-0" />
                <span>{{ $t('tour.feature2') }}</span>
              </li>
              <li class="flex items-center gap-2">
                <CheckCircle2 class="w-4 h-4 text-emerald-500 shrink-0" />
                <span>{{ $t('tour.feature3') }}</span>
              </li>
            </ul>
