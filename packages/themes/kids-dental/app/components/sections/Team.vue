    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center max-w-3xl mx-auto mb-14 space-y-3">
        <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-100 text-indigo-800 font-bold text-xs">
          ...
          <span data-i18n="team.badge">{{ $t('team.badge') }}</span>
        </div>
        
        <h2 data-i18n="team.title" class="text-3xl sm:text-4xl lg:text-5xl font-black text-indigo-950 tracking-tight">
          {{ $t('team.title') }}
        </h2>
        
        <p data-i18n="team.subtitle" class="text-base sm:text-lg text-slate-600 font-normal leading-relaxed">
          {{ $t('team.subtitle') }}
        </p>
      </div>
