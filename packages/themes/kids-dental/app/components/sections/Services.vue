    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center max-w-3xl mx-auto mb-14 space-y-3">
        <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-100 text-emerald-800 font-bold text-xs">
          ...
          <span data-i18n="services.badge">{{ $t('services.badge') }}</span>
        </div>
        
        <h2 data-i18n="services.title" class="text-3xl sm:text-4xl lg:text-5xl font-black text-indigo-950 tracking-tight">
          {{ $t('services.title') }}
        </h2>
        
        <p data-i18n="services.subtitle" class="text-base sm:text-lg text-slate-600 font-normal leading-relaxed">
          {{ $t('services.subtitle') }}
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          ...
          <div class="pt-6 mt-4 border-t border-slate-200/60">
            ...
            >
              <span data-i18n="services.learnMore">{{ $t('services.learnMore') }}</span>
