...
('John Smith', 'john.smith@email.com', 'Appointment Request', 'I would like to schedule a teeth cleaning appointment for next week.', NOW()),
('Emily Brown', 'emily.brown@email.com', 'Invisalign Inquiry', 'I am interested in Invisalign treatment. Could you provide pricing information?', NOW()),
('Michael Johnson', 'michael.j@email.com', 'Emergency', 'I have a severe toothache and need to be seen as soon as possible.', NOW()),
('Sarah Davis', 'sarah.davis@email.com', 'Feedback', 'Thank you for the wonderful care during my implant procedure. The team was amazing!', NOW()),
('Robert Wilson', 'robert.w@email.com', 'Insurance Question', 'Do you accept Delta Dental insurance? I am considering switching to your clinic.', NOW());
