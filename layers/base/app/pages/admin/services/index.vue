  ...
  <div class="grid gap-6 lg:grid-cols-2">
    <section class="card bg-base-100 shadow">
      <div class="card-body space-y-3">
        ...
        <div class="flex gap-2"><button class="btn btn-primary" @click="save">{{ $t('common.save') }}</button><button
            class="btn" @click="reset">{{ $t('common.cancel') }}</button></div>
      </div>
    </section>
    <section class="card bg-base-100 shadow">
      <div class="card-body">
        ...
        <div class="space-y-2">
          <div v-for="item in data" :key="item.id" class="flex items-center justify-between rounded border p-2">
            ...
            }}</button><button class="btn btn-xs btn-error" @click="remove(item.id)">{{ $t('common.delete')
                }}</button></div>
          </div>
        </div>
      </div>
