...
14. [Critical Rules the AI Must Follow](#14-critical-rules-the-ai-must-follow)
...
## 14. Critical Rules the AI Must Follow
...
6. **Write `pages/index.vue`** composing desired section components (§6)
...
14. **Write `THEME_VARIABLES.md`** documenting expected keys in `about.info` etc. (§13)
